...
of `openspec.change.document`) through a deterministic parser; no model SHALL
interpret the artifacts on the ingest path (G3). Parsing SHALL be lenient — bullet, heading-case, and
