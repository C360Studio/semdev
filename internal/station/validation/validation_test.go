...
func TestHandleRejectsMissingRunEntity(t *testing.T) {
	...
	h := &handler{reader: errReader{}, runner: nopRunner{}, writer: okWriter{}, logger: slog.Default()}
...
func TestHandleFailsClosedOnValidateError(t *testing.T) {
	...
	h := &handler{reader: errReader{err: errors.New("graph down")}, runner: nopRunner{}, writer: okWriter{}, logger: slog.Default()}
